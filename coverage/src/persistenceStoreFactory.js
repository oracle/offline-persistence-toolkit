...
if (! _$jscoverage['/persistenceStoreFactory.js']) {
  _$jscoverage['/persistenceStoreFactory.js'] = {};
  _$jscoverage['/persistenceStoreFactory.js'].lineData = [];
  _$jscoverage['/persistenceStoreFactory.js'].lineData[6] = 0;
  _$jscoverage['/persistenceStoreFactory.js'].lineData[7] = 0;
  _$jscoverage['/persistenceStoreFactory.js'].lineData[18] = 0;
  _$jscoverage['/persistenceStoreFactory.js'].lineData[22] = 0;
}
if (! _$jscoverage['/persistenceStoreFactory.js'].functionData) {
  _$jscoverage['/persistenceStoreFactory.js'].functionData = [];
  _$jscoverage['/persistenceStoreFactory.js'].functionData[0] = 0;
  _$jscoverage['/persistenceStoreFactory.js'].functionData[1] = 0;
}
if (! _$jscoverage['/persistenceStoreFactory.js'].branchData) {
  _$jscoverage['/persistenceStoreFactory.js'].branchData = {};
}
_$jscoverage['/persistenceStoreFactory.js'].lineData[6]++;
define([], function() {
  _$jscoverage['/persistenceStoreFactory.js'].functionData[0]++;
  _$jscoverage['/persistenceStoreFactory.js'].lineData[7]++;
  'use strict';
  _$jscoverage['/persistenceStoreFactory.js'].lineData[18]++;
  var PersistenceStoreFactory = {
  createPersistenceStore: function(name, options) {
  _$jscoverage['/persistenceStoreFactory.js'].functionData[1]++;
}};
  _$jscoverage['/persistenceStoreFactory.js'].lineData[22]++;
