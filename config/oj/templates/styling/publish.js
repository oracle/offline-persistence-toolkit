...
// Styling doc should only list non-abstract classes having styling doc, including 
// components, non-component classes like OffcanvasUtils, and the non-component 
// styling doc, and excluding abstract superclass components like editableValue.
function includeClass(clazz) {
    return !clazz.virtual && !!find({
        kind: 'member', memberof: clazz.longname, name: ['stylingDoc']
    }).length;
}
...
function buildJETNav(members) {
    ...
    members.classes.forEach(function(c) {
      if ( !hasOwnProp.call(seen, c.longname) && includeClass(c)) {
        ...
        //   3. "regular" classes
        (c.ojcomponent ? (c.virtual ? abstractComponents : components) 
                       : (c.ojstylingdoc ? styling : classes)
            ).push(c);
        }
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    view.find = find;
    view.includeClass = includeClass;
    view.linkto = linkto;    
    ...
    Object.keys(helper.longnameToUrl).forEach(function(longname) {
        ...
        if (myClasses.length) {
          ...
          var pageTitle = (myClasses[0].ojPageTitlePrefix || 'Class: ') + (myClasses[0].ojPageTitle || myClasses[0].name);
          debugger;
